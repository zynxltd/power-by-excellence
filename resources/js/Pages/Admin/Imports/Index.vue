...
<template>
    ...
    <AuthenticatedLayout>
        <PageHeader title="CSV Imports" description="Bulk import leads from CSV files into campaigns." />
        ...
        <div class="space-y-6">
            <Panel title="Upload CSV">
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="file" accept=".csv" class="mt-1 block w-full text-sm text-slate-500 file:mr-4 file:rounded-lg file:border-0 file:bg-indigo-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-indigo-700 dark:file:bg-indigo-500/15 dark:file:text-indigo-400" @change="onFile" required />
                    </div>
            ...
            <Panel title="Import History" :padding="false">
                <DataTable :empty="!imports.data?.length">
                    <template #head>
