...
const statusStyles = {
    ...
    upgrade: 'bg-violet-100 text-violet-800 dark:bg-violet-900/40 dark:text-violet-300',
    cap_reached: 'bg-rose-100 text-rose-800 dark:bg-rose-900/40 dark:text-rose-300',
};
