...
const cloneDelivery = (id) => {
    router.post(route('deliveries.clone', id));
};
                ...
                <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    >
                        ...
                        <div class="flex border-t border-slate-100 bg-slate-50/50 dark:border-slate-800 dark:bg-slate-800/30">
                            ...
                            <button
                                type="button"
                                class="flex-1 border-l border-slate-100 px-4 py-2.5 text-center text-xs font-medium text-violet-600 hover:bg-violet-50 dark:border-slate-800 dark:text-violet-400 dark:hover:bg-violet-950/30"
                                @click="cloneDelivery(d.id)"
                            >
                                Clone
                            </button>
                            <Link
            ...
            <DataTable :empty="!deliveries?.length" empty-message="No deliveries match your filters.">
                ...
                <ClickableTableRow v-for="d in deliveries" :key="d.id" :href="route('deliveries.show', d.id)">
                    ...
                    <td class="px-6 py-4 text-right" @click.stop>
                        <button type="button" class="mr-3 text-xs font-medium text-violet-600 hover:text-violet-500 dark:text-violet-400" @click="cloneDelivery(d.id)">Clone</button>
