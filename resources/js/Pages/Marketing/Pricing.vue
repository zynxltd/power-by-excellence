...
const usageRows = [
    ...
    { label: 'Tracked clicks / month (Click Track)', format: (t) => (t.name === 'Starter' ? 'Add-on' : t.name === 'Growth' ? '100,000' : 'Unlimited') },
    { label: 'Conversions tracked / month', format: (t) => (t.name === 'Starter' ? 'Add-on' : t.name === 'Growth' ? '25,000' : 'Unlimited') },
