...
class BuyerController extends Controller
{
    ...
    protected function validateBuyer(Request $request, ?Buyer $buyer = null): array
    {
        ...
        $validated = $request->validate([
            ...
            'settings.portal_logo_url' => 'nullable|url|max:2048',
            'settings.portal_primary_color' => ['nullable', 'string', 'max:7', 'regex:/^#[0-9A-Fa-f]{6}$/'],
            'settings.portal_welcome_text' => 'nullable|string|max:500',
