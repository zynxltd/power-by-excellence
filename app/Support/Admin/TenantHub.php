        ...
        return [
            ...
            [
                ...
                'links' => array_values(array_filter([
                    ...
                    ['label' => 'Saved reports', 'href' => route('saved-reports.index'), 'description' => 'Reusable report definitions'],
                    ['label' => 'Scheduled exports', 'href' => route('scheduled-exports.index'), 'description' => 'Automated CSV delivery'],
                    ['label' => 'Export tenant data', 'href' => route('tools.data-export.index'), 'description' => 'GDPR subject access request export'],
                    ['label' => 'Marketing suppressions', 'href' => route('marketing-opt-outs.index'), 'description' => 'Email and SMS opt-out list'],
                    ['label' => 'E-Delivery', 'href' => route('e-delivery.index'), 'description' => 'Email/SMS campaigns, segments, deliverability'],
                    ['label' => 'Click Track', 'href' => route('click-track.dashboard'), 'description' => 'Affiliate links, clicks, conversions'],
                    ['label' => 'Call Logic', 'href' => route('call-logic.settings.edit'), 'description' => 'Call tracking, IVR, pay-per-call'],
